---
title: Api options
description: Guide to the available API options for configuring Cookiebot.
navigation:
  icon: i-lucide-sliders-vertical
seo:
  title: API options for Cookiebot in Nuxt
  description: Learn about the available API options for configuring Cookiebot.
---

Fore more info, consult the [Cookiebot docs](https://www.cookiebot.com/en/developer/){:target="_blank"}.
